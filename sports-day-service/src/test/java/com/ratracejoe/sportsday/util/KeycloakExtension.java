...
public class KeycloakExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    public String login() {
        ...
        JsonNode response = keycloakClient.post()
    ...
    public void beforeAll(ExtensionContext context) throws Exception {
        keycloak.start();
        keycloakClient = RestClient.builder()
                .baseUrl(getIssuerUri())
                .build();
    }
    @Override
    ...
    public String getIssuerUri() {
        return String.format("http://localhost:%d/realms/ratracejoe", keycloak.getMappedPort(KEYCLOAK_PORT));
    }
}
